...
public class SimpleTooltipV2 implements PopupWindow.OnDismissListener {

    private static final String TAG = SimpleTooltipV2.class.getSimpleName();
    ...
    private SimpleTooltipV2(Builder builder) {
        ...
        mRootView = SimpleTooltipUtilsV2.findFrameLayout(mAnchorView);
    ...
    private PointF calculePopupLocation() {
        ...
        final RectF anchorRect = SimpleTooltipUtilsV2.calculeRectInWindow(mAnchorView);
    ...
    public void onDismiss() {
        ...
        SimpleTooltipUtilsV2.removeOnGlobalLayoutListener(mPopupWindow.getContentView(), mLocationLayoutListener);
        SimpleTooltipUtilsV2.removeOnGlobalLayoutListener(mPopupWindow.getContentView(), mArrowLayoutListener);
        SimpleTooltipUtilsV2.removeOnGlobalLayoutListener(mPopupWindow.getContentView(), mShowLayoutListener);
        SimpleTooltipUtilsV2.removeOnGlobalLayoutListener(mPopupWindow.getContentView(), mAnimationLayoutListener);
        SimpleTooltipUtilsV2.removeOnGlobalLayoutListener(mPopupWindow.getContentView(), mAutoDismissLayoutListener);
    ...
    private final ViewTreeObserver.OnGlobalLayoutListener mLocationLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() {
        ...
        public void onGlobalLayout() {
            ...
            if (mMaxWidth > 0 && mContentView.getWidth() > mMaxWidth) {
                SimpleTooltipUtilsV2.setWidth(mContentView, mMaxWidth);
                popup.update(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
                return;
            }

            SimpleTooltipUtilsV2.removeOnGlobalLayoutListener(popup.getContentView(), this);
    ...
    private final ViewTreeObserver.OnGlobalLayoutListener mArrowLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() {
        ...
        public void onGlobalLayout() {
            ...
            if (mShowArrow) {
                RectF achorRect = SimpleTooltipUtilsV2.calculeRectOnScreen(mAnchorView);
                RectF contentViewRect = SimpleTooltipUtilsV2.calculeRectOnScreen(mContentLayout);
                float x, y;
                if (mArrowDirection == ArrowDrawable.TOP || mArrowDirection == ArrowDrawable.BOTTOM) {
                    x = mContentLayout.getPaddingLeft() + SimpleTooltipUtilsV2.pxFromDp(2);
                    ...
                    y = mContentLayout.getPaddingTop() + SimpleTooltipUtilsV2.pxFromDp(2);
                ...
                SimpleTooltipUtilsV2.setX(mArrowView, (int) x);
                SimpleTooltipUtilsV2.setY(mArrowView, (int) y);
            }
            popup.getContentView().requestLayout();
        }
    };
    ...
    private final ViewTreeObserver.OnGlobalLayoutListener mShowLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() {
        ...
        public void onGlobalLayout() {
            ...
            if (mOnShowListener != null)
                mOnShowListener.onShow(SimpleTooltipV2.this);
    ...
    public interface OnDismissListener {
        void onDismiss(SimpleTooltipV2 tooltip);
    }

    public interface OnShowListener {
        void onShow(SimpleTooltipV2 tooltip);
    }
    ...
    public static class Builder {
        ...
        public SimpleTooltipV2 build() throws IllegalArgumentException {
            validateArguments();
            if (backgroundColor == 0) {
                backgroundColor = SimpleTooltipUtilsV2.getColor(context, mDefaultBackgroundColorRes);
            }
            ...
            if (textColor == 0) {
                textColor = SimpleTooltipUtilsV2.getColor(context, mDefaultTextColorRes);
            }
            if (contentView == null) {
                TextView tv = new TextView(context);
                SimpleTooltipUtilsV2.setTextAppearance(tv, mDefaultTextAppearanceRes);
                tv.setBackgroundColor(backgroundColor);
                tv.setTextColor(textColor);
                contentView = tv;
            }
            if (arrowColor == 0) {
                arrowColor = SimpleTooltipUtilsV2.getColor(context, mDefaultArrowColorRes);
            }
            if (margin < 0) {
            ...
            if (showArrow) {
                if (arrowDirection == ArrowDrawable.AUTO)
                    arrowDirection = SimpleTooltipUtilsV2.tooltipGravityToArrowDirection(gravity);
            ...
            return new SimpleTooltipV2(this);
        }
        ...
        public Builder arrowDrawable(@DrawableRes int drawableRes) {
            this.arrowDrawable = SimpleTooltipUtilsV2.getDrawable(context, drawableRes);
            return this;
        }
